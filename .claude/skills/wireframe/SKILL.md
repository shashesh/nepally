...
├── [screen-name]-clean.html      # Clean minimal
├── [screen-name]-sketch.html     # Balsamiq hand-drawn
├── [screen-name]-tailwind.html   # Tailwind-inspired
└── [screen-name]-material.html   # Material Design
```
...
## Step 3: Render All Styles

After creating the `.md` file, run all 5 render commands:
```bash
wiremd docs/wireframes/[name]/[name].md --style wireframe -o docs/wireframes/[name]/[name]-wireframe.html
wiremd docs/wireframes/[name]/[name].md --style clean -o docs/wireframes/[name]/[name]-clean.html
wiremd docs/wireframes/[name]/[name].md --style sketch -o docs/wireframes/[name]/[name]-sketch.html
wiremd docs/wireframes/[name]/[name].md --style tailwind -o docs/wireframes/[name]/[name]-tailwind.html
wiremd docs/wireframes/[name]/[name].md --style material -o docs/wireframes/[name]/[name]-material.html
```
