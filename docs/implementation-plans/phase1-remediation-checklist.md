...
| NOTIF-01 | P0 | Notifications | Register device/browser tokens in real app lifecycle (mobile + web) | TBD | Not Started | Sprint 2 | 2026-03-23 | helper functions exist but not wired |
| NOTIF-02 | P0 | Notifications | Complete and deploy push delivery path (edge function wiring, trigger strategy, web VAPID delivery) | TBD | Not Started | Sprint 2 | 2026-03-23 | edge function contains TODOs |
| NOTIF-03 | P1 | Notifications | Add robust notification deep-link routing for post/message/event/emergency/system payloads | TBD | Not Started | Sprint 2 | 2026-03-23 | currently post_id-centric |
