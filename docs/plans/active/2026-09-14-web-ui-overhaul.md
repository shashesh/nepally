...
| 10c Shared + mobile parity, archive | `chore/mobile-parity` | 10c.1–10c.16, in four chunks | In Progress | 2026-09-24 | branched from `master` at 617bbb9 (PR #93 merged). Migration 040 (`full_name` ≤ 100) has the user's go-ahead (2026-09-24); applied in chunk 4, after 10c.5 makes `createUserProfile` fit it |
