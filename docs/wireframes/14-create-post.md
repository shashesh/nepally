...
**Screen Number:** 14
**Journey Reference:** Post Creation User Journey
**User Story:** As a verified (Level 1+) user, I want to create a post with a title, body, and tags so I can share information with my local community (or globally if I'm a premium user).
...
```
┌─────────────────────────────────────────┐
│ ✕ Cancel        Create Post      Post → │ ← Top nav: 44px height
│                                         │    Cancel (left), Post (right)
├─────────────────────────────────────────┤
│                                         │
│ Title                                   │ ← Title input: single line
│ ─────────────────────────────────────── │    Placeholder: "What's this about?"
│                                         │
│ Body                                    │ ← Body textarea: multiline
│ Write your post details here...         │    Placeholder text, expands
│                                         │
│                                         │
│                                         │
│                                         │
│ ─────────────────────────────────────── │
│                                         │
│ Tags (1-3 required)                     │ ← Section label
│ ┌────────┐ ┌──────┐ ┌──────┐ ┌────────┐│ ← Tag chips (scrollable)
│ │🏠 House│ │💼Jobs│ │🤝Help│ │❓Quest.││    Tap to select/deselect
│ └────────┘ └──────┘ └──────┘ └────────┘│
│ ┌────────┐ ┌──────────┐ ┌───────────┐  │
│ │🏛 Polit│ │💬Discuss.│ │⚠️Emergenc│  │
│ └────────┘ └──────────┘ └───────────┘  │
│                                         │
│ ─────────────────────────────────────── │
│                                         │
│ 📷 Add Photos (optional)          0/5  │ ← Photo picker row
│                                         │
│ ─────────────────────────────────────── │
│                                         │
│  📍 Posting to: Dallas-Fort Worth       │ ← Location info (read-only)
│                                         │
│                                         │
│                                         │
└─────────────────────────────────────────┘
...
### iOS Layout (Premium User - Global Toggle Visible)
...
│                                         │
│  🌐 Post Globally                [OFF] │ ← Premium toggle
│     Visible in all metro areas          │    Only shown for premium users
│                                         │
└─────────────────────────────────────────┘
```
...
**Padding:** 16px/dp horizontal, 12px/dp vertical
**Background:** White (#FFFFFF)
...
- **Typography:** 20pt/18sp Semibold, #212121
...
**Type:** Multi-line text input (auto-expanding)
**Padding:** 16px/dp horizontal, 12px/dp vertical
**Background:** White (#FFFFFF)
**Border:** 1px top border #E0E0E0
**Minimum Height:** 120px/dp
**Maximum Height:** Scrollable after 300px/dp

**Styling:**
- **Placeholder:** "Write your post details here..."
- **Placeholder Color:** #9E9E9E
- **Typography:** 16pt/15sp Regular, #212121
...
**Type:** Wrapped grid of selectable tag chips
**Padding:** 16px/dp horizontal
**Background:** White (#FFFFFF)
**Border:** 1px top border #E0E0E0

**Section Label:**
- **Text:** "Tags (1-3 required)"
- **Typography:** 14pt/13sp Semibold, #757575
- **Margin:** 12px/dp bottom
...
**Type:** Horizontal photo picker row
**Padding:** 16px/dp horizontal
**Background:** White (#FFFFFF)
**Border:** 1px top border #E0E0E0

**Add Photos Button:**
- **Icon:** 📷 Camera icon, 24x24px/dp
- **Label:** "Add Photos (optional)"
- **Counter:** "0/5" (right-aligned)
- **Typography:** 15pt/14sp Regular, #757575
- **Touch Target:** Full row height (48px/dp)
...
**Type:** Read-only informational row
**Padding:** 16px/dp horizontal, 12px/dp vertical
**Background:** #F5F5F5 (Light Gray)
**Border:** 1px top border #E0E0E0

**Content:**
- **Icon:** 📍 Pin icon, 20x20px/dp
- **Label:** "Posting to: Dallas-Fort Worth" (user's current metro area)
...
**Type:** Toggle switch row
**Padding:** 16px/dp horizontal, 12px/dp vertical
**Background:** White (#FFFFFF)
**Border:** 1px top border #E0E0E0
**Visibility:** Only shown if `user.is_premium === true`

**Components:**
- **Icon:** 🌐 Globe icon, 20x20px/dp
- **Label:** "Post Globally"
- **Sublabel:** "Visible in all metro areas"
- **Typography:**
  - Label: 15pt/14sp Medium, #212121
  - Sublabel: 12pt/11sp Regular, #757575
- **Toggle Switch:** Standard iOS/Android switch
  - Off: Gray track (#E0E0E0)
  - On: Blue track (#1565C0)
...
### Color Contrast
- Title text (#212121 on #FFFFFF): 16.9:1 ✓
- Placeholder text (#9E9E9E on #FFFFFF): 3.4:1 (informational only)
- Tag text (various on white): All meet 4.5:1 ✓
- Post button (#FFFFFF on #1565C0): 7.2:1 ✓
...
**Previous Screen:** [06-home-screen-level-0.md](./06-home-screen-level-0.md) (via FAB)
**Next Screen:** Home Screen (on success, post appears at top of feed)
**Related Screens:**
- [09-post-detail.md](./09-post-detail.md) — View of the created post
- Post Edit Screen (reuses same form with pre-filled data)
